 ...
 * @author maria
 */
public class AudioFormulario extends javax.swing.JFrame {

    /**
     * Creates new form AudioFormulario
     */
    public AudioFormulario() {
        super("Formulario De CDs Audios");
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Numero de canciones: ");
        ...
        jButton3.setText("Agregar cd audio");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AudioFormulario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AudioFormulario().setVisible(true);
            }
        });
    }
